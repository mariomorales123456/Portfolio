...
<!-- //////////////  Java   ///////////////////// -->
        ...
        <div class="row justify-content-center">
             <pre><?php echo htmlentities(file_get_contents('activity_main_java.php')); ?></pre>
        </div>
        <div class="row justify-content-center">
             <pre><?php echo htmlentities(file_get_contents('date_picker_java.php')); ?></pre>
        </div>
        <div class="row justify-content-center">
             <pre><?php echo htmlentities(file_get_contents('gridview_java.php')); ?></pre>
        </div>
        <div class="row justify-content-center">
             <pre><?php echo htmlentities(file_get_contents('radio_timer_play_pause_java.php')); ?></pre>
        </div>
        <div class="row justify-content-center">
             <pre><?php echo htmlentities(file_get_contents('splash_activity_java.php')); ?></pre>
        </div>
    </div>
</div>