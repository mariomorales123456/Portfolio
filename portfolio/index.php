...
<section class="container text-center">
    <h2>Resume</h2>
    <p><a class="hover_underline_animation" href="documents/Mario Morales Developer Resume May 2022.pdf" target="_blank">Mario Morales Resume</a></p>   
</section>
...
<div class="row">
    ...
    <div class="col">
        <p>Bachelor in Science Degree<br>
        Confer Date: 3/14/2014<br>
        Plan: Bachelor in Science-Animal Health Sciences<br>
        </p>
    </div>
</div>   <!-- /* Row End */ --> 
</div>   <!-- /* Container End */ --> 
