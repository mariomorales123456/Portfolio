...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="dropdown-item" href="<?php echo $index ?>#cosn215_project2"><span class="hover_underline_animation">SSH &amp; Apache Web Server</span></a></li>
        <li><a class="dropdown-item" href="<?php echo $index ?>#cosn215_project3"><span class="hover_underline_animation">IDS &amp; Snort</span></a></li>
        <li><a class="dropdown-item" href="<?php echo $index ?>#cosn215_project4"><span class="hover_underline_animation">Pam, GRUB &amp; AppArmor</span></a></li>
