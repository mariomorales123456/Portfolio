...
<div id="welcome-section">
     ...
     <!--==============================SECTION START============================================-->          
          <section id="final_project" class="container">
 <!------------------------------------ROW START-------------------------------------->  
              <div class="row">
                <div class="col-lg-12">
        <h2 class="text-center">Final Project</h2> <!--title of section-->
                    </div>
             </div> 
<!------------------------------------ROW END--------------------------------------->
<!------------------------------------ROW START-------------------------------------->  
...
<!------------------ROW START----------------------> 
        ...
        <div class="col-lg-12">
            ...
            <figure>
            <a href="images/final_project_main.PNG" target="_blank"><img src="images/final_project_main.PNG" alt="final_project_screenshot" class="img-fluid"></a><figcaption class="text-center">Click <a href="final_project/index.html" target="_blank">here</a> to go to site</figcaption>
            </figure>
        </div>
    </div>
<!------------------ROW END---------------------->
<!------------------ROW START----------------------> 
        <div class="row reflection">
            ...
            <p>The aim of this project was to use basic HTML and CSS to create a 5-page mock website.</p>
                </div>
        </div>
<!------------------ROW END---------------------->         
        </div>
